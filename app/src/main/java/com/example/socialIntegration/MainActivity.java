...
public class MainActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener{
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        if (fb_settings.getString("fb_logged", "").equals("fb_logged")) {
            startActivity(new Intent(MainActivity.this, UserProfile.class));
            this.finish();
        }else if (email_settings.getString("gmail_logged", "").equals("gmail_logged")) {
        ...
        ClickableSpan clickableSpan = new ClickableSpan() {
            ...
            public void onClick(@NonNull View view) {
                startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://smi-0.flycricket.io/privacy.html")));
            }
        };
        ...
        ClickableSpan clickableSpan1 = new ClickableSpan() {
            @Override
            public void onClick(@NonNull View view) {
                startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://smi-0.flycricket.io/terms.html")));
            }
        };
